...
import wz.p;
import zz.a;
/* compiled from: DeleteAccountClicked.kt */
/* loaded from: classes2.dex */
public final class DeleteAccountClickedEvent implements c {

    /* renamed from: a  reason: collision with root package name */
    private final b f33115a = b.f54803a;

    @Override // u9.c
    public Object a(a<? super AnalyticsParameters> aVar) {
        return AnalyticsParameters.f21956b.invoke(new l<AnalyticsParameters, p>() { // from class: com.forsale.app.features.more.user.editprofile.analytics.DeleteAccountClickedEvent$createParams$2
