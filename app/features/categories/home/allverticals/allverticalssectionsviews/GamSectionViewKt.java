...
import wz.p;
import yj.d;
/* compiled from: GamSectionView.kt */
/* loaded from: classes2.dex */
public final class GamSectionViewKt {
    public static final void a(final AdManagerAdRequest gamRequest, final int i11, a aVar, final int i12) {
        List q11;
        o.i(gamRequest, "gamRequest");
        a h11 = aVar.h(1009570378);
        if (c.I()) {
            c.U(1009570378, i12, -1, "com.forsale.app.features.categories.home.allverticals.allverticalssectionsviews.AllVerticalsGAMSection (GamSectionView.kt:18)");
        }
        ...
        String b12 = g.b(i11, h11, (i12 >> 3) & 14);
        ...
        GamComposeKt.a(b12, (AdSize[]) Arrays.copyOf(adSizeArr, adSizeArr.length), gamRequest, false, e11, null, h11, 3648, 32);
        h11.S();
        h11.w();
        h11.S();
        h11.S();
        ...
        d1 l11 = h11.l();
        if (l11 != null) {
            l11.a(new g00.p<a, Integer, p>() { // from class: com.forsale.app.features.categories.home.allverticals.allverticalssectionsviews.GamSectionViewKt$AllVerticalsGAMSection$2
                ...
                public final void b(a aVar4, int i13) {
                    GamSectionViewKt.a(AdManagerAdRequest.this, i11, aVar4, v0.a(i12 | 1));
                }
