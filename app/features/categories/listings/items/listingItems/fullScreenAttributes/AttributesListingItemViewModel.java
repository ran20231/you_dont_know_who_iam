...
import t9.y0;
/* compiled from: AttributesListingItemViewModel.kt */
/* loaded from: classes2.dex */
public final class AttributesListingItemViewModel extends DefaultListingItemViewModel {
    ...
    public /* synthetic */ class a {
        ...
        public static final /* synthetic */ int[] f30817b;
    ...
    public /* synthetic */ AttributesListingItemViewModel(ListingItemBrief listingItemBrief, ListingsResponse.UISettings.ListingsSettings listingsSettings, LiveData liveData, LiveData liveData2, ApplicationResourcesRepository applicationResourcesRepository, p pVar, int i11, int i12, String str, r rVar, boolean z11, CategoryEntity.Classification classification, CardDisplayTypes cardDisplayTypes, ListingsVerticalStyles listingsVerticalStyles, List list, ListingsAnalytics$FiltersPlace listingsAnalytics$FiltersPlace, ListingDetailsSearchAnalyticsData listingDetailsSearchAnalyticsData, SortingStates sortingStates, List list2, int i13, DefaultConstructorMarker defaultConstructorMarker) {
        this(listingItemBrief, listingsSettings, liveData, liveData2, applicationResourcesRepository, pVar, i11, i12, (i13 & 256) != 0 ? null : str, (i13 & AdRequest.MAX_CONTENT_URL_LENGTH) != 0 ? new r<ListingItemBrief, Integer, Integer, ListingDetailsSearchAnalyticsData, wz.p>() { // from class: com.forsale.app.features.categories.listings.items.listingItems.fullScreenAttributes.AttributesListingItemViewModel.1
        ...
        } : rVar, (i13 & 1024) != 0 ? true : z11, classification, cardDisplayTypes, (i13 & 8192) != 0 ? null : listingsVerticalStyles, (i13 & Http2.INITIAL_MAX_FRAME_SIZE) != 0 ? null : list, (32768 & i13) != 0 ? null : listingsAnalytics$FiltersPlace, (i13 & 65536) != 0 ? null : listingDetailsSearchAnalyticsData, sortingStates, list2);
    }
    ...
    private final Integer Z() {
        ...
        if (userType == null) {
            ...
            i11 = a.f30816a[userType.ordinal()];
        }
        if (i11 == 1) {
    ...
    public AttributesListingItemViewModel(ListingItemBrief item, ListingsResponse.UISettings.ListingsSettings listingsSettings, LiveData<RegionEntity> region, LiveData<MasterDataMiscModel> misc, ApplicationResourcesRepository resourcesRepository, p<? super ListingItemBrief, ? super List<? extends Object>, wz.p> analyticLambda, int i11, int i12, String str, r<? super ListingItemBrief, ? super Integer, ? super Integer, ? super ListingDetailsSearchAnalyticsData, wz.p> onItemClicked, boolean z11, CategoryEntity.Classification classification, CardDisplayTypes cardDisplayTypes, ListingsVerticalStyles listingsVerticalStyles, List<String> list, ListingsAnalytics$FiltersPlace listingsAnalytics$FiltersPlace, ListingDetailsSearchAnalyticsData listingDetailsSearchAnalyticsData, SortingStates sortingState, List<Integer> swipingIds) {
