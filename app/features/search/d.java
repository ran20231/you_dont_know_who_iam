...
public abstract class d<B extends ViewDataBinding, VM extends BaseStatefulViewModel> extends com.forsale.app.base.fragments.b<B, VM> implements mx.b {
    private boolean A;
    ...
    private ContextWrapper f36981z;

    private void M() {
        if (this.f36981z == null) {
            this.f36981z = dagger.hilt.android.internal.managers.g.b(super.getContext(), this);
    ...
    protected void O() {
        if (!this.D) {
            this.D = true;
            ((f0) F()).u((SearchFragment) mx.d.a(this));
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        ContextWrapper contextWrapper = this.f36981z;
